 ...
 * @old license? CC Attribution-No Derivative Works 2.5 Brazil - http://creativecommons.org/licenses/by-nd/2.5/br/deed.en_US
 * @website states this license (changed to this?): CC Attribution-Share Alike 2.5 Brazil - http://creativecommons.org/licenses/by-sa/2.5/br/deed.en_US
...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			'<?php echo $siteroot;?>ruubikcms/website/css/images/lightbox-ico-loading.gif',		// (string) Path and the name of the loading icon
