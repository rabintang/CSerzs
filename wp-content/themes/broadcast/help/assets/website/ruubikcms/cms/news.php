...
if (isset($_POST['save'])) {
	...
	if ($_GET['id']) {
		...
		$stmt->bindParam(3, stripslashes($_POST['tinyMCE']));
		$stmt->bindParam(4, substr($_POST['shorttext'], 0, $site['news_maxshort']));
			...
			<!-- **************** RightDiv ******************** -->    
                ...
                <div id="rightDiv">
					...
					<div id="rightContent">					
						...
						<div id="tinyMCE">
							<textarea cols="63" rows="20" name="tinyMCE" class="tinyMCE"><?php if (isset($news['text'])) echo htmlentities($news['text']);?></textarea>
						</div>
