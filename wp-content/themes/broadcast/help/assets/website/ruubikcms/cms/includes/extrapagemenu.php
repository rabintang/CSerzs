			<!-- **************** leftDiv (rootMenu) ******************** -->
                ...
                <div id="leftDiv">
					<div class="blueHeader"><?php echo EXTRAPAGES;?><div id="showAll">&nbsp;</div><div id="showMain">&nbsp;</div></div>
					...
					<div id="pageManagement">
						...
						<?php
							...
							foreach ($dbh->query($sql) as $row) {
								...
								echo '
									<div class="arrowdiv1"><a href="extranet.php'.'?p='.$row['pageurl'].'&amp;moveup=1&amp;token='.$token.'"><img src="images/arrow1.gif" class="imgover" alt="arrow" /></a></div>
								...
								foreach ($dbh->query($sql2) as $row2) {
									echo '
										<div class="subPage1"><div class="arrowdiv2"><a href="extranet.php'.'?p='.$row2['pageurl'].'&amp;moveup=1&amp;token='.$token.'"><img src="images/arrow2.gif" class="imgover" alt="arrow" /></a></div>
									...
									foreach ($dbh->query($sql3) as $row3) {
										echo '
											<div class="subPage2"><div class="arrowdiv2"><a href="extranet.php'.'?p='.$row3['pageurl'].'&amp;moveup=1&amp;token='.$token.'"><img src="images/arrow2.gif" class="imgover" alt="arrow" /></a></div>
											<div class="subButton2"><a href="extranet.php'.'?p='.$row3['pageurl'].'"'.($row3['pageurl'] == $p ? ' class="selected"' : '').'>'.ec($row3['name']).'</a></div></div>';
									}
								}

								echo '
									</div> <!-- end subMenu1 div-->';

							}

							// loop free pages
							echo '
									<div class="rootPageFree"><a href="extranet.php'.'?p=---notinmenu---">'.FREEPAGES.'</a></div>
							...
							foreach ($dbh->query($sql) as $row) {
								echo '
										<div class="subPage1"><div class="arrowdiv2"><a href="extranet.php'.'?p='.$row['pageurl'].'&amp;moveup=1&amp;token='.$token.'"><img src="images/arrow2.gif" class="imgover" alt="arrow" /></a></div>
