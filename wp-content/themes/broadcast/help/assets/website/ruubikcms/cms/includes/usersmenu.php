                ...
                <div id="leftDiv">
					...
					<div id="pageManagement">
						...
						<?php
							...
							if (!isset($_GET['role'])) $_GET['role'] = 5;
						
							echo '
									<div class="newsButton"><a href="users.php?role=5">'.ADMINISTRATORS.'</a></div>
							...
							echo '
									<div class="newsButton"><a href="users.php?role=4">'.SUPEREDITORS.'</a></div>
							...
							echo '
									<div class="newsButton"><a href="users.php?role=3">'.PUBLISHERS.'</a></div>
							...
							echo '
														...
														echo '
									<div class="newsButton"><a href="users.php?role=2">'.CONTRIBUTORS.'</a></div>
