<?php
error_reporting(0); // switch off error handling, to use custom handler
/*
...
session_start();
$tinybrowser['sessioncheck'] = 'uid'; //name of session variable to check
...
// ** PATHS MOVED TO ruubik_paths.php
// File upload paths (set to absolute by default)
//$tinybrowser['path']['image'] = '/ruubikcms/useruploads/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
//$tinybrowser['path']['media'] = '/ruubikcms/useruploads/media/'; // Media files location
//$tinybrowser['path']['file']  = '/ruubikcms/useruploads/files/'; // Other files location

// File upload paths (relative example)
...
// php default timezone - possible values http://php.net/manual/en/timezones.php
...
$tinybrowser['filetype']['media'] = '*.swf, *.dcr, *.mov, *.qt, *.mpg, *.mp3, *.mp4, *.mpeg, *.avi, *.wmv, *.wm, *.asf, *.asx, *.wmx, *.wvx, *.rm, *.ra, *.ram, *.flv, *.f4v'; // Media file types
$tinybrowser['filetype']['file']  = '*.*'; // Other file types

// Prohibited file extensions
$tinybrowser['prohibited'] = array('php','php3','php5','phtml','asp','aspx','ascx','jsp','cfm','cfc','pl','bat','exe','dll','reg','cgi', 'sh', 'py','asa','asax','config','com','inc');
